...
void main() {
  print("Enter the number of ascii emojis you want to see:");
  int total = int.parse(stdin.readLineSync());
  var group = [], count = 0;
  for (var i = 0; i < total; i++) {
    print(getResponse(total, i));
  }
}

String getResponse(int total, int i) {
  String v = getSpace((i - total)) + getRandonAsciiEmoji();
  String complement = v + v + v + v;
  return getSpace(i) + getRandonAsciiEmoji() + complement;
}
...
String getRandonAsciiEmoji() {
  final _random = new Random();
  return ascii_emojis[_random.nextInt(ascii_emojis.length)].toString();
}

List<String> ascii_emojis = [
  /*acid:*/ "⊂(◉‿◉)つ",
  /*afraid:*/ "(ㆆ _ ㆆ)",
  /*alpha:*/ "α",
  /*angel:*/ "☜(⌒▽⌒)☞",
